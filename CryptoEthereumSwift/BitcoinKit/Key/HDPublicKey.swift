...
public class HDPublicKey {
    ...
    public func derived(at index: UInt32) throws -> HDPublicKey {
        ...
        guard let derivedKey = KeyDerivation(privateKey: nil, publicKey: raw, chainCode: chainCode, depth: depth, fingerprint: fingerprint, childIndex: childIndex).derived(at: index, hardened: false) else {
