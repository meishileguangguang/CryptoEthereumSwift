...
public class Peer : NSObject, StreamDelegate {
    ...
    private func sendVersionMessage() {
        ...
        let checksum = Data(Crypto.doubleSHA256(payload).prefix(4))
    ...
    private func sendTransactionInventory(transaction: Transaction) {
        let txId = Crypto.doubleSHA256(transaction.serialized())
    ...
    private func handleBlockMessage(payload: Data) {
        ...
        let blockHash = Data(Crypto.doubleSHA256(payload.prefix(80)).reversed())
    ...
    private func handleMerkleBlockMessage(payload: Data) {
        ...
        let blockHash = Crypto.doubleSHA256(payload.prefix(80))
    ...
    private func handleTransaction(payload: Data) {
        ...
        let txHash = Data(Crypto.doubleSHA256(payload).reversed())
